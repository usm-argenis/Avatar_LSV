...
def convertir_blend_a_glb(categoria, animacion_nombre):
    ...
    blend_file = BLEND_DIR / categoria / f"Luis_resultado_{animacion_nombre}.blend"
    glb_output = BLEND_DIR / categoria / f"Luis_resultado_{animacion_nombre}.glb"
