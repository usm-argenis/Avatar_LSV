...
def retarget_animacion(categoria, animacion_nombre):
    ...
    # Archivos
    nina_file = BASE_DIR / "Duvall" / categoria / f"Duvall_resultado_{animacion_nombre}.glb"
    blend_output = BLEND_OUTPUT_DIR / categoria / f"Luis_resultado_{animacion_nombre}.blend"
    ...
    try:
        ...
        for obj in bpy.data.objects:
            if obj.type == 'ARMATURE':
                nancy_armature = obj
                nancy_armature.name = "Luis_Armature"
                break
        ...
        for obj in bpy.data.objects:
            if obj.type == 'ARMATURE' and obj != nancy_armature:
                nina_armature = obj
                nina_armature.name = "Duvall_Armature"
                break
