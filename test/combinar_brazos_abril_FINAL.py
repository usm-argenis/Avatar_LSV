...
output_path = Path(r"C:\Users\andre\OneDrive\Documentos\tesis\test\output\Duvall_abril_brazos_combinado_FINAL.blend")
...
print("\nRetarget DIRECTO - Copiando rotaciones quaternion...")
...
for frame in range(frame_start, frame_end + 1):
    ...
    for fbx_bone_name, glb_bone_name in bone_mapping.items():
        ...
        # RETARGET DIRECTO: Copiar solo la rotación quaternion
        # El FBX usa location (0,0,0) y scale (1,1,1), solo rota
        
        # Asegurar que GLB use quaternions
        glb_pose_bone.rotation_mode = 'QUATERNION'
        
        # Copiar directamente la rotación del FBX
        glb_pose_bone.rotation_quaternion = fbx_pose_bone.rotation_quaternion.copy()
        
        # Mantener location y scale del GLB (no modificar)
        # glb_pose_bone.location se mantiene
        # glb_pose_bone.scale se mantiene
...
print("\nMÉTODO: Retarget directo de rotaciones quaternion sin conversión de espacios.")
