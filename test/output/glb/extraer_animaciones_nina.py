"""
Script para extraer SOLO las animaciones de los archivos GLB de Nina
...
def main():
    print("=" * 60)
    print("🎬 EXTRACTOR DE ANIMACIONES - NINA")
    print("=" * 60)
    print()
    
    # Rutas base
    base_nina = "Nina"
    carpeta_salida = "Nina_animation"
    ...
    for categoria in CATEGORIAS:
        ...
        carpeta_origen = os.path.join(base_nina, categoria)
