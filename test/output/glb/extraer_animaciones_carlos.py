"""
Script para extraer SOLO las animaciones de los archivos GLB de Carlos
...
def main():
    print("=" * 60)
    print("🎬 EXTRACTOR DE ANIMACIONES - CARLOS")
    print("=" * 60)
    print()
    
    # Rutas base
    base_carlos = "Carlos"
    carpeta_salida = "Carlos_animation"
    ...
    for categoria in CATEGORIAS:
        ...
        carpeta_origen = os.path.join(base_carlos, categoria)
