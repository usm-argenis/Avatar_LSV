"""
Script para extraer SOLO las animaciones de los archivos GLB de Luis
...
def main():
    print("=" * 60)
    print("🎬 EXTRACTOR DE ANIMACIONES - LUIS")
    print("=" * 60)
    print()
    
    # Rutas base
    base_luis = "Luis"
    carpeta_salida = "Luis_animation"
    ...
    for categoria in CATEGORIAS:
        ...
        carpeta_origen = os.path.join(base_luis, categoria)
