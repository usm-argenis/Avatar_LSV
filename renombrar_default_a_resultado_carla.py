...
def renombrar_archivos_default(carpeta):
    """
    Renombra archivos con patrón *_default.glb a Carla_resultado_*.glb
    
    Ejemplo:
        hola_default.glb -> Carla_resultado_hola.glb
        cosa_default.glb -> Carla_resultado_cosa.glb
    """
    ...
    for archivo in archivos_default:
        ...
        if nombre_original.endswith("_default"):
            ...
            # Crear nuevo nombre
            nuevo_nombre = f"Carla_resultado_{palabra}.glb"
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        ...
        print("\nUso:")
        print("  python renombrar_default_a_resultado_carla.py <carpeta>")
        print("\nEjemplo:")
        print("  python renombrar_default_a_resultado_carla.py C:\\Users\\andre\\Downloads")
        print("  python renombrar_default_a_resultado_carla.py test/output/glb/Carla/deepmotion")
        sys.exit(1)
